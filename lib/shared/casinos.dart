...
List<Map<String, dynamic>> casinos = [
  {
    ...
    'tableMin': 15,
    'tableMax': 200,
    'bgGradient': LinearGradient(colors: [Colors.blue[100] ?? Colors.blue, Colors.blueGrey[600] ?? Colors.blueGrey], begin: Alignment.topCenter, end: Alignment.bottomCenter),
    'unlockAt': 0,
  ...
  },
  {
    ...
    'tableMin': 25,
    'tableMax': 350,
    'bgGradient': LinearGradient(colors: [Colors.brown[400] ?? Colors.brown, Colors.brown[100] ?? Colors.brown ], begin: Alignment.topCenter, end: Alignment.bottomCenter),
    'unlockAt': 200,
  ...
  },
  {
    ...
    'tableMin': 35,
    'tableMax': 500,
    'bgGradient': LinearGradient(colors: [Colors.brown[300] ?? Colors.brown, Colors.grey[500] ?? Colors.grey], begin: Alignment.topCenter, end: Alignment.bottomCenter),
    'unlockAt': 300,
  ...
  },
  {
    ...
    'tableMin': 50,
    'tableMax': 750,
    'bgGradient': LinearGradient(colors: [Colors.lightBlue[400] ?? Colors.blue, Colors.lightBlue[100] ?? Colors.lightBlue], begin: Alignment.topCenter, end: Alignment.bottomCenter),
    'unlockAt': 400,
  ...
  {
    'location': 'Gotham Ophanage',
    'locationImage': 'assets/casino_slides/gotham_orphanage.jpg',
    'dealerImage': 'assets/dealers/riddler.jpg',
    'dealer': 'The Riddler',
    'villainColor': BatmanColors.jokerGreen,
    'tableMin': 60,
    'tableMax': 800,
    'bgGradient': LinearGradient(colors: [Colors.green[400] ?? Colors.green, Colors.green[100] ?? Colors.green], begin: Alignment.topCenter, end: Alignment.bottomCenter),
    'unlockAt': 475,
    'wallpaper': 'assets/wallpapers/riddler.jpg',
    'openCasino': 'orphanage',
    'welcomeMessage':'"I have no mouth, yet I speak of fortune and doom. I hold kings and queens, but they\'re mere paper in my tomb. I promise prosperity, but often deliver despair. What am I, that holds twenty-one, and leaves you with nothing to spare?"\n\n\n... the answer\'s \'blackjack\', stupid.',
  },
  {
  ...
  },
  {
    ...
    'villainColor': BatmanColors.jokerPurple,
    'tableMin': 85,
    'tableMax': 1000,
